...
class TextCNN(object):
    ...
    def __init__(self,config):
        ...
        self.global_step = tf.compat.v1.Variable(150000, trainable=False, name='global_step', dtype= tf.int64)
    ...
    def cnn(self):
        ...
        with tf.name_scope('conv'):
            ...
            for i, filter_size in enumerate(self.config.filter_sizes):
                with tf.compat.v1.variable_scope("conv-maxpool-%s" % filter_size,reuse=False):
