...
class TextConfig():
    ...
    BIOBERT_BASE_DIR = './pretrained_bert_model/biobert_v1.1_pubmed/'
    vocab_file = BIOBERT_BASE_DIR+'vocab.txt'  # the path of vocab file
    bert_config_file = BIOBERT_BASE_DIR+'bert_config.json'  # the path of BIO bert_cofig file
    init_checkpoint = BIOBERT_BASE_DIR + 'model.ckpt-1000000'  # the path of BIO bert model
